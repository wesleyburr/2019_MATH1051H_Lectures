...
<center>
```{r, messages = FALSE, echo = FALSE, fig.height = 4, fig.width = 7}
dat <- data.frame(Results = c(2.3107, 2.30986, 2.31010, 2.31001, 2.31026, 2.31163, 2.30956, 2.31024, 2.31010, 2.31028,2.30143, 2.29890, 2.29816, 2.30182, 2.29869, 2.29940, 2.29849, 2.29889, 2.30074, 2.30054),
                  Type = c(rep("Air", 10), rep("Chem", 10)))
library("ggplot2")
g <- ggplot(dat = dat, aes(Type, Results)) + geom_boxplot() 
g
```
</center>
...
<center>
```{r, out.width = "800px", echo = FALSE}
knitr::include_graphics("fig/pie_chart1.jpg")
```
</center>
Image from: https://priceonomics.com/should-you-ever-use-a-pie-chart/.

***

<center>
```{r, out.width = "800px", echo = FALSE}
knitr::include_graphics("fig/pie_chart2.jpg")
```
</center>
...
<center>
```{r, out.width = "800px", echo = FALSE}
knitr::include_graphics("fig/pie_chart3.jpg")
```
</center>
...
1. <span id="highlight">The mean and median are approximately the same.</span>
2. The mean tends to be greater than the median.
3. The mean tends to be less than the median.
4. We do not have enough information to determine the relative sizes of the mean and median.
...
1. The mean and median are approximately the same.
2. <span id="highlight">The mean tends to be greater than the median.</span>
3. The mean tends to be less than the median.
4. We do not have enough information to determine the relative sizes of the mean and median.
...
1. Mean
2. <span id="highlight">Median</span>
3. Standard deviation
4. Interquartile range
