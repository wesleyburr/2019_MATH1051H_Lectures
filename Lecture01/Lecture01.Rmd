...
* **WeBWorK**: weekly assignments (digital)
* **Chat ('Mattermost')**: asking questions, communicating, sharing, talking to the TAs and me
* **rstudio.cloud**: learning to **do** statistics and data analysis (3 assignments)
* **Slides and Videos**: Blackboard and on math.trentu.ca
...
In addition, the bookstore still stocks the 3rd edition, and if you like dead trees and
marking up your books, I encourage you to pick up a paper copy. It's only $16, so it won't
break the bank.

Everything we do in the course will reference **both** versions - the 4th edition has some
additional material added, but only went to print in July so we weren't able to stock it in
time. 
...
In addition, there is a book on the use of R and R programming available in the bookstore. It's a 
...
for later. It's about \$55 in the bookstore, or you can save \$20 and get an electronic copy
from Amazon.
...
* [RStudio Quick Demo](http://rstudio.cloud/)
* [WeBWorK Quick Demo](http://math.trentu.ca/webwork2/)
* [Mattermost Quick Demo](http://math.trentu.ca:8065/math1051/)
